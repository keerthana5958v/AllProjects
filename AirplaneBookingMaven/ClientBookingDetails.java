...
public class ClientBookingDetails extends FlightDetails {
    ...
    String getNumber() {
        ...
        } else if (getNumberCount < 6) {
            System.out.println(ConsoleColors.YELLOW + "Enter your 10 digit mobile number:\t" + ConsoleColors.RESET);
        } else {
            System.out.println(ConsoleColors.RED + "Enter your 10 digit mobile number:\t" + ConsoleColors.RESET);
        }
        getNumberCount++;
        return sc.nextLine();
    }
    ...
    public void isMealIncluded() {
        ...
        do {
            ...
            if (result.equals("Y")) {
                System.out.println(ConsoleColors.GREEN + "Meals are included in your ticket." + ConsoleColors.RESET);
                getValidMealType();
            }
            if (result.equals("N")) {
                System.out.println(ConsoleColors.GREEN + "Meals are not a part of your ticket" + ConsoleColors.RESET);
            }
        }
