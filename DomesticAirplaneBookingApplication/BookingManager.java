...
public class BookingManager {
    protected  void invoiceBillGenerator(long cost) {
    ...
    protected static void generateQRPattern(){
    ...
    protected void printTicketDetails(String airline, String location, String destination,String flightNumber, String date, String time, String seatNo){
    ...
    protected BookingManager(String airline, String location, String destination,String flightNumber, String date, String time, String seatNo){
