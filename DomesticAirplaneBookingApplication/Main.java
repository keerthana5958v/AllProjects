...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        instruction.askFAQ();
        ClientBookingDetails details = new ClientBookingDetails();// problem while constructor creating at parent class
...
//totally 59 methods without including main
//8 classes without main